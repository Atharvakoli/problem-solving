...
public class FirstWeek {
	...
	public static void rotateArray(int[] arr, int n, int position) {
		// O(n * position)
		// int i = 0;
		// while (i < position) {
		// // 1,2,3,4
		...
		position %= n;// for position greater then n
		reverse(arr, 0, position - 1);// 2 1 3 4
		reverse(arr, position, n - 1); // 2 1 4 3
		reverse(arr, 0, n - 1); // 3 4 1 2
	}
	...
	public static void main(String[] args) {
		...
		// linearSearch(arr, 71);
		// if (palindromeNumber(1121)) {
		// System.out.println("Number is palindrome :) ");
		// } else {
		// System.out.println("Number is not palindrome :) ");
		// }

		System.out.println(countNumberOfDigits(123456789));
